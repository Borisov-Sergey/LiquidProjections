...
namespace LiquidProjections.Specs
{
    ...
    {
        public class When_a_projector_throws_an_exception_that_the_dispatcher_rethrows : GivenSubject<Dispatcher>
        {
            public When_a_projector_throws_an_exception_that_the_dispatcher_rethrows()
            {
                Given(() =>
                {
